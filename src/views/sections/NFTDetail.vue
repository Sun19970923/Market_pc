          ...
          <div class="right-section-inner">
              ...
              <div class="right-main-content-top">
                ...
                <div class="nft-metas">
                  <template v-if="!lowestAsset">
                    ...
                    <span class="nft-meta cblue">0 of {{info.quantity}}</span>
                  </template>
                  <template v-else>
                    <span class="nft-meta">
                    ...
                    <span class="nft-meta c9"> ${{ lowestAsset.singleUsdtPrice }} </span>
                    <span class="nft-meta cblue"> 
                      {{ info.sellQuantity || 0 }} of {{ info.quantity }}
                    </span>
                  </template>
                </div>
            ...
            <div class="right-footer-wrap">
              ...
              <div class="right-footer">
                <div class="right-footer-body">
                  <template v-if="myAsset">
                    <el-button
                      type="primary"
                      v-if="!myAsset.onsell"
                      @click="showDialog('sale', myAsset)"
                      >
                      {{ $t("nftDetail.sale") }}
                    </el-button>
                    <el-button
                      type="primary"
                      v-else-if="myAsset.onsell"
                ...
                <div class="right-footer-footer" v-if="!myAsset && !highestBid">
...
export default {
  ...
  methods: {
          ...
          if (res.data.items) {
            for (let i = 0; i < res.data.items.length; i++) {
              if (res.data.items[i].onsell) {
                ...
                if (_sellQuantity > item.quantity)
                  _sellQuantity = item.quantity;
    ...
    analysisNFT() {
      if (this.connected) {
        this.myAsset = this.getAddressAsset(
          this.owners,
          this.user.coinbase,
        );
