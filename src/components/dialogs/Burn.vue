  ...
  >
    ...
    <div class="cel-dialog-body" v-if="!confirm">
      ...
      <div class="process"  >
        ...
        <div class="input-group" v-if="$sdk.keyAssetType(nft.type) != 'ERC721'">
          <div class="input-info">
            <div class="tip"><span>{{$t('dialog.burnQuantity')}}</span>
              <span class="gray-font">({{ asset.quantity}} {{$t('dialog.available')}})</span>
            </div>
