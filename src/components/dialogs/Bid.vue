        ...
        <div class="input-group">
          <div class="input-info">
            ...
            <div class="stip">
              ...
              <div class="stip-item">{{ $t('dialog.pay')}} <span class="bfont"> {{pay.pay}}{{ payToken.symbol}}</span> ${{pay.usdt}} </div>
          ...
          <div class="input-info" v-if="$sdk.keyAssetType(nft.type) != 'ERC721'">
            ...
            <el-input class="cel-dialog-input" placeholder="0.0" type="number"
