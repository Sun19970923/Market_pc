<template>
  <el-dialog :model-value="visible" :show-close="false" :close-on-click-modal="false" :modal="false"
    @close="$emit('close')" @closed="closed" custom-class="cel-dialog" destroy-on-close>
    <template #title>
    ...
    <div class="cel-dialog-body">
      ...
      <div class="process">
        <div class="step-info">
          ...
          <span v-if="step.fileUp != 1" :class="step.fileUp== 2 ? 'finish': ''"
            class="step iconfont icon-seleted"></span>
          <div class="step loading" v-else>
            <img class="loading-animation" src="@/assets/img/loading.png" />
          </div>
      ...
      <div class="process">
        <div class="step-info">
          ...
          <span v-if="step.mint != 1" :class="step.mint== 2 ? 'finish': ''"
            class="step iconfont icon-seleted"></span>
          <div class="step loading" v-else>
            <img class="loading-animation" src="@/assets/img/loading.png" />
          </div>
      ...
      <div class="process" v-if="nft.form.onSale">
        <div class="step-info">
          ...
          <span v-if="step.sale != 1" :class="step.sale == 2 ? 'finish': ''"
            class="step iconfont icon-seleted"></span>
          <div class="step loading" v-else>
            <img class="loading-animation" src="@/assets/img/loading.png" />
          </div>
